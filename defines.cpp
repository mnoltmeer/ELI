...
const wchar_t *SCEXCEPT = L"Throwing exception";
...
const wchar_t *PROCNAMEXST = L"Procedure with selected name already exists";
...
const wchar_t *FRGMNTERR = L"Code fragment translating error";
const wchar_t *FRGMNTNOTFND = L"Code fragment not found";
const wchar_t *FRGMNTCRTERR = L"Code fragment creating error";
...
const wchar_t *DBGST = L"[START]";
const wchar_t *DBGOK = L"[OK]";
const wchar_t *DBGFL = L"[FAIL]";
